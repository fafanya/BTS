...
{
    public class TServiceNpgsql : TServiceDB
    {
        public TServiceNpgsql()
        {
            ConnectionString = ConfigurationManager.ConnectionStrings["NpgsqlConnectionString"].ConnectionString;
        }
